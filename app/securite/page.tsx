        ...
        <div className="mt-10 text-zinc-300 text-[15.5px] leading-relaxed space-y-8">
          ...
          <section className="space-y-3">
            ...
            <p className="text-zinc-400">
              La meilleure façon de sécuriser une donnée est de ne pas la collecter. L'écosystème <span className="font-medium text-zinc-200">Scryboo Tools</span> s'appuie exclusivement sur des technologies d'exécution côté client. Grâce à des binaires WebAssembly (WASM) hautement optimisés, le traitement de vos documents s'opère de manière isolée directement dans le bac à sable (sandbox) de votre navigateur. <b className="text-zinc-200 font-medium">Zéro téléversement par défaut, zéro persistance externe.</b>
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-zinc-400">
              Tous nos échanges réseaux transitent obligatoirement par des tunnels sécurisés exploitant le protocole <b className="text-zinc-300 font-medium">TLS 1.3</b> combiné à une politique HSTS stricte. Pour nos modules nécessitant la conservation de préférences ou de clés d'accès (comme l'architecture Vault), nous appliquons des mécanismes de chiffrement de bout en bout (<b className="text-zinc-300 font-medium">E2E</b>) où les clés de déchiffrement restent en votre possession et ne sont jamais transmises en clair à nos services.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-zinc-400">
              La sécurité est un processus collaboratif continu. Nous accueillons avec beaucoup d'intérêt le travail des chercheurs en sécurité et des hackers éthiques. Si vous identifiez une faille ou une faiblesse au sein de l'écosystème Scryboo, veuillez nous le signaler exclusivement via notre canal dédié :{" "}
              <a
            ...
            <p className="text-zinc-400">
              Nous nous engageons à analyser votre rapport et à vous apporter un premier retour technique sous <span className="text-zinc-200 font-medium">48 heures ouvrées</span>. Les contributions valides et documentées de manière responsable seront publiquement saluées au sein de notre <span className="italic text-zinc-300">Hall of Fame</span>.
            </p>
          </section>
